...
final class Symbol
{
    ...
    public static function pickSmallest(int $dataCodewordCount): self
    {
        ...
        throw new PdfException("DataMatrix data too large: {$dataCodewordCount} codewords exceeds largest square (144x144, 1558 data codewords)");
    }
