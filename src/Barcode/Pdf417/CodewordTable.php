...
/**
 * PDF417 symbol-character module patterns (ISO/IEC 15438 Table 1).
 *
 * Each codeword (0-928) maps to a 17-module pattern in each of the three
 * clusters (row group = row index mod 3). Patterns are 17-bit integers read
 * MSB-first; a set bit is a dark module. The start pattern is 17 modules wide,
 * the stop pattern 18 modules.
 *
 * The 3 x 929 table and the start/stop patterns are ported verbatim from the
 * zxing PDF417.java CODEWORD_TABLE / START_PATTERN / STOP_PATTERN (Apache 2.0).
 *
 * @internal
 */
final class CodewordTable
{
    ...
    /**
     * The 929 patterns for the given cluster (0, 1 or 2).
     *
     * @return list<int>
     */
    public static function patterns(int $cluster): array
    {
        self::$table ??= self::build();
        return self::$table[$cluster];
    }
