...
- PAdES-B-LT full profile (per-signature `/VRI`), incremental update over externally-supplied PDFs, and certifying (author / MDP) signatures - later phases.
