...
- **Arabic shaping** - contextual letter joining and ligatures. RTL reordering works, but Arabic currently renders as unjoined isolated letters (Hebrew needs no shaping and is complete).
- **RTL in Markdown**, bidi explicit embedding/override/isolate controls, and per-column-header direction in tables.
