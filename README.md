...
- Multiple signatures per document, document timestamps (`/DocTimeStamp`), DSS / LTV / PAdES-B-LT - later phases.
...
- Not yet supported: multiple signatures, document timestamps (`/DocTimeStamp`), DSS / LTV, and `ETSI.CAdES.detached`.
