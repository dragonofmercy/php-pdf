...
final class SvgCssSpecificityTest extends TestCase
{
    ...
    public function testSvgCssSpecificityPassesQpdfCheck(): void
    {
    ...
    public static function buildPdfBytes(): string
    {
        ...
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 100">'
            . '<style>.hl { fill: #dd2222 } #target { fill: #22aa44 }</style>'
            . '<rect id="target" class="hl" x="10" y="10" width="180" height="80"/>'
            . '</svg>';
