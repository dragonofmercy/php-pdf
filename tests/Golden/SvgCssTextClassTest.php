...
final class SvgCssTextClassTest extends TestCase
{
    ...
    public function testSvgCssTextClassPassesQpdfCheck(): void
    {
    ...
    public static function buildPdfBytes(): string
    {
        ...
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 100">'
            . '<style>.title { font-family: serif; font-size: 28; font-weight: bold; text-anchor: middle; fill: #114488 }</style>'
            . '<text class="title" x="100" y="60">Styled</text>'
            . '</svg>';
