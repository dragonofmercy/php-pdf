...
final class PdfA2bTest extends TestCase
{
    private const string FIXTURE = __DIR__ . '/fixtures/pdfa/a2b.pdf';
    ...
    public static function buildDocument(): Document
    {
        ...
        $page->text(50, 60, 'Long-term archival sample (PDF/A-2b).');
