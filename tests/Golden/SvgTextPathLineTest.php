...
final class SvgTextPathLineTest extends TestCase
{
    private const string FIXTURE = 'svg/text/textpath-line.pdf';

    public static function buildPdfBytes(): string
    {
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 120">'
            . '<defs><path id="p" d="M20,90 L280,90"/></defs>'
            . '<text font-size="20" fill="#1a1a1a"><textPath href="#p" startOffset="10">Text on a line</textPath></text>'
            . '</svg>';
