...
final class BarcodeSvgQrTest extends TestCase
{
    public function testMatchesFixtureBytes(): void
    {
        $expected = file_get_contents(__DIR__ . '/../fixtures-svg/barcode-svg-qr.svg');
    ...
    {
        return (new SvgBarcodeRenderer())->render(QrCode::of('https://example.com'), 200, 200);
    }
}
