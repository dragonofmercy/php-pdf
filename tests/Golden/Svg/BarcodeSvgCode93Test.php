...
final class BarcodeSvgCode93Test extends TestCase
{
    public function testMatchesFixtureBytes(): void
    {
        $expected = file_get_contents(__DIR__ . '/../fixtures-svg/barcode-svg-code93.svg');
    ...
    {
        return (new SvgBarcodeRenderer())->render(Code93::of('TEST93'), 300, 100);
    }
}
