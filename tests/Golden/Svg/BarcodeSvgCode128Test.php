...
final class BarcodeSvgCode128Test extends TestCase
{
    public function testMatchesFixtureBytes(): void
    {
        $expected = file_get_contents(__DIR__ . '/../fixtures-svg/barcode-svg-code128.svg');
    ...
    {
        return (new SvgBarcodeRenderer())->render(Code128::of('HELLO 128'), 300, 100);
    }
}
