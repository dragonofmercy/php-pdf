...
{
    private const string FIXTURE = __DIR__ . '/fixtures/pdfa/a2u.pdf';
    ...
    public static function buildDocument(): Document
    {
        ...
        $page->text(50, 60, 'Long-term archival sample (PDF/A-2u).');
        $doc->enablePdfA(PdfALevel::A2U);
        return $doc;
    }
}
