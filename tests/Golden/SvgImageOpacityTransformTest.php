...
final class SvgImageOpacityTransformTest extends TestCase
{
    ...
    public function testSvgImageOpacityTransformPassesQpdfCheck(): void
    {
        Qpdf::assertCheck(__DIR__ . '/fixtures/svg/image/opacity-transform.pdf');
    }
    ...
    public static function buildPdfBytes(): string
    {
        ...
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><image x="20" y="20" width="60" height="60" opacity="0.6" transform="rotate(15 50 50)" href="' . $uri . '"/></svg>';
