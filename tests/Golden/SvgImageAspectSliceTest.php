...
final class SvgImageAspectSliceTest extends TestCase
{
    ...
    public function testSvgImageAspectSlicePassesQpdfCheck(): void
    {
        Qpdf::assertCheck(__DIR__ . '/fixtures/svg/image/aspect-slice.pdf');
    }
    ...
    public static function buildPdfBytes(): string
    {
        ...
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><image x="0" y="0" width="100" height="100" preserveAspectRatio="xMidYMid slice" href="' . $uri . '"/></svg>';
