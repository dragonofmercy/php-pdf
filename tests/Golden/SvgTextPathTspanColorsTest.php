...
{
    private const string FIXTURE = 'svg/text/textpath-tspan-colors.pdf';

    public static function buildPdfBytes(): string
    {
        $svg = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 300 120">'
            . '<defs><path id="p" d="M20,90 L280,90"/></defs>'
            . '<text font-size="20"><textPath href="#p" startOffset="10">'
            . '<tspan fill="#cc0000">Red</tspan><tspan fill="#0000cc">Blue</tspan>'
            . '</textPath></text>'
            . '</svg>';
