...
final class PdfA2aUaTest extends TestCase
{
    private const string FIXTURE = __DIR__ . '/fixtures/pdfa/a2a-ua.pdf';
    ...
    public static function buildDocument(): Document
    {
        $doc = new Document();
        $doc->metadata()
            ->title('Accessible archive (PDF/A-2a + PDF/UA-1)')
            ->creator('phppdf')
        ...
        $page->markdown("# Accessible archive\n\nBoth PDF/A-2a and PDF/UA-1 in one file.");
