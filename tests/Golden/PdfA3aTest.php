...
final class PdfA3aTest extends TestCase
{
    private const string FIXTURE = __DIR__ . '/fixtures/pdfa/a3a.pdf';
    ...
    public static function buildDocument(): Document
    {
        ...
        $page->cell(w: 120, h: 10, text: 'Accessible archival sample (PDF/A-3a).');
