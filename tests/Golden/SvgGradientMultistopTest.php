...
final class SvgGradientMultistopTest extends TestCase
{
    ...
    public function testSvgGradientMultistopPassesQpdfCheck(): void
    {
        Qpdf::assertCheck(__DIR__ . '/fixtures/svg/gradient/multistop.pdf');
    }
