...
final class SvgGradientOpacityTest extends TestCase
{
    ...
    public function testSvgGradientOpacityPassesQpdfCheck(): void
    {
        Qpdf::assertCheck(__DIR__ . '/fixtures/svg/gradient/opacity.pdf');
    }
