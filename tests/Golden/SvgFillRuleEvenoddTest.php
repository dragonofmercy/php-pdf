...
final class SvgFillRuleEvenoddTest extends TestCase
{
    ...
    {
        $expected = file_get_contents(__DIR__ . '/fixtures/svg/basic/fill-rule-evenodd.pdf');
    ...
    public function testSvgFillRuleEvenoddPassesQpdfCheck(): void
    {
        ...
        $process = new Process([$qpdf, '--check', __DIR__ . '/fixtures/svg/basic/fill-rule-evenodd.pdf']);
        $process->run();
        self::assertSame(
            0,
            $process->getExitCode(),
