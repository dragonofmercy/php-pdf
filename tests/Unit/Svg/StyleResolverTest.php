...
final class StyleResolverTest extends TestCase
{
    ...
    public function testCssBeatsPresentationAttribute(): void
    {
        $out = StyleResolver::resolve(
            SvgPaint::default(),
            ['fill' => 'red'],
        ...
        self::assertNotNull($out->fill);
        self::assertEquals(SvgColor::fromBytes(0, 128, 0), $out->fill);
    }

    public function testInlineStyleBeatsCss(): void
    {
        $out = StyleResolver::resolve(
            SvgPaint::default(),
            [],
    ...
    public function testCssOnlyPropertyApplies(): void
    {
        $out = StyleResolver::resolve(
            SvgPaint::default(),
            [],
        ...
        self::assertSame(3.0, $out->strokeWidth);
    }
}
