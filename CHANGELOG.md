...
### Changed
- Maintenance re-release of 1.12.1 with no functional changes - the same UTF-8 force-break fix, republished with corrected release metadata. If you are already on 1.12.1, upgrading is optional.
